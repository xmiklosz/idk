...
int main() {
    ...
    cout << "   Algorithm 4.4 - Basic Greedy Approach\n";
    cout << "   AZA 2025/26 Assignment - PART 1\n";
    cout << "==========================================\n\n";
    ...
    cout << "==========================================\n";
    cout << "- Sorting jobs by profit: O(n log n)\n";
    cout << "- Main loop: n iterations\n";
    cout << "- Feasibility check per iteration: O(n log n)\n";
    cout << "  (sorting + linear check)\n";
    cout << "- Overall Time Complexity: O(n² log n)\n";
    cout << "- Space Complexity: O(n)\n\n";

    cout << "Algorithm Steps:\n";
    cout << "1. Sort all jobs by profit (descending)\n";
    cout << "2. Start with highest profit job\n";
    cout << "3. For each remaining job:\n";
    cout << "   - Try adding it to current schedule\n";
    cout << "   - Check if still feasible (all deadlines met)\n";
    cout << "   - Keep it if feasible, reject otherwise\n";
    cout << "4. Return the feasible schedule with max profit\n";
